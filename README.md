...
**测试覆盖**：441 个测试（含 119 个压力/边界测试），90% 代码覆盖率，覆盖路径遍历、SSRF、Shell 注入、大输入、Unicode、权限压力、并发安全、数学 DoS、压缩集成、并行调度、流式响应、后台任务、交互式工具、CLI 参数解析、日志系统、Hook 子进程执行、Web 工具 Mock、Monitor 流读取、文档工具等场景。
