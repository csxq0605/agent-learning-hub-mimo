...
基于 Stage 0-8 经验构建的生产级 Agent Harness，参考 Claude Code 架构。

**核心特性**：Agent Loop、30 个工具、权限管线、安全管线、上下文管理、记忆系统、会话管理、Hook 系统、SubAgent、Skills、MCP 支持、TUI、CLI
...
cd Agent-Learning-Hub-MiMo/mimo-harness
pip install -e .
