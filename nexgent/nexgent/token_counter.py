...
_logger = logging.getLogger("nexgent.token_counter")
...
class StreamingTokenCounter:
    ...
    def add_text(self, text: str) -> int:
        ...
        if len(self._buffer) >= 200:
            ...
            # After flush, buffer is empty so precise count is the total
            self.total_tokens = max(prev_total, self._precise_count)
